...
export const OrcamentoPageTemplate = () => {
  ...
  return (
    ...
    >
      ...
      <Navigation />
      <section className="flex md:px-4 justify-center items-center  max-w-7xl relative w-full flex-col z-10 pt-[20vh]">
        <div className="pb-16 w-full text-center flex justify-center items-center flex-col">
          ...
          <h2 className="text-3xl font-display font-bold cursor-default sm:text-5xl md:text-6xl mb-2 text-gray-200 ">
